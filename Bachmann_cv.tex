...
\nobibliography{cv}
    ...
    \begin{bibenum}
        ...
        \item \bibentry{staff_science_2021}
    \end{bibenum}
    % Media Coverage
    ...
    \section{\mysidestyle Professional\\Service}
        \textbf{Member}, ANS Chicago Local Section Board \hfill \textbf{2024--Present}\vspace{0.5mm}\\
        \textbf{Chair Elect}, U.S. WIN Communications Committee \hfill \textbf{2023--Present} \vspace{0.5mm}\\%
    ...
    \section{\mysidestyle Volunteer\\Work}
                \textbf{Moderator}, Illinois Science Bowl \hfill\textbf{Feb 2023}\\
