...
\nobibliography{cv}
    ...
    \begin{list2}
        ...
        \item NEUP Fellow, Building Future Faculty Program Fellow
        \item GPA: 3.94/4.0
    \end{list2}
    %GPA: /4.04,0
    ...
    \textbf{Argonne National Lab}, Lemont, IL \hfill \textbf{May-August 2022}\\
    ...
    \textbf{U. of Michigan NERS} \textsl{Lunch with the Chair}\hfill \textbf{Sept 12, 2022}\\
