...
\nobibliography{cv}
    ...
    NEUP Fellow \hfill mobile: (813) 495-5698 \vspace{0mm}\\\vspace{0mm}%
        ...
        \hfill e-mail: amandab7@illinois.edu            \vspace{0mm}\\\vspace{0mm}%
    ...
    \textbf{University of Tennessee, Knoxville}, \textsc{Nuclear Engineering}\hfill\textbf{August 2019 -- August 2020}\vspace{-3mm}\\\vspace{-1mm}%
    \begin{list2}
    ...
    \textbf{University of Illinois at Urbana-Champaign}, Urbana, IL\\
                \textsl{NEUP Fellow, Nuclear Plasma and Radiological Engineering} \hfill \textbf{Aug 2020 -- Present}\\
                Investigating the impact of HALEU fuel on the nuclear fuel cycle

    \textbf{University of Tennessee, Knoxville, NE Dept.}, Knoxville, TN \\
                \textsl{Graduate Research Assistant} \hfill \textbf{Aug 2019 -- Aug 2020}\\
                Developed multivariate models of used nuclear fuel signatures
    ...
    %\textbf{<++>}, <++>, \emph{<++>}.  \hfill\textbf{<+mo+> <+date+>, <+yy+>}\\
    \textbf{U.S. WIN National Conference}, San Fransisco, CA, \emph{Invited Breakout Session Speaker}\hfill\textbf{July 25, 2017}

    %__________________________________________________________________________________________________________________
    % Panels
    \section{\mysidestyle Panels\\Appearances}
    ...
    \section{\mysidestyle Volunteer\\Work}
                \textbf{Rules Judge}, Tennessee Science Bowl \hfill \textbf{Febs 2018--2020}
   ...
   %__________________________________________________________________________________________________________________
    ...
    Four day course on modeling and simulation of used nuclear fuel using the SCALE suite of codes and their applications to safeguards \\
